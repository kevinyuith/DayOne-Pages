...
/** Window for the "Seen in the logs, not registered" list. */
const SEEN_DAYS = 30;
        ...
        <Table>
          ...
          <tbody>
            {domains.map((d) => (
              <Tr key={d.id}>
                <Td>
                  <Link href={`/domains/${d.id}`} className="font-medium hover:text-accent">
                    {d.domain}
                  </Link>
                </Td>
                ...
                <Td className="text-right">
                  <div className="flex flex-wrap justify-end gap-1">
                    ...
                    <RowAction
                      ...
                      label="Remove"
                      variant="danger"
                      confirm={`Remove ${d.domain} and all its pages?`}
                    />
                  </div>
                </Td>
              </Tr>
