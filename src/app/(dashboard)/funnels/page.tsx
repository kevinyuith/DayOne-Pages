...
/**
 * The dayone-main funnels (F1, F2…) as a list, each with its pages
 * (pages.funnels) and the A/B test between them. `?days=` picks the period
 * (New York days, including today); `?f=<id>` opens a funnel (back from the editor).
 */
