-- ============================================================================
-- DayOne Pages — the rule's URL parameter gains "not equals" and
-- "absent or equals" matchers
--
-- So a rule can catch a click-tracking macro that was never replaced
-- ("_CLICKID_", "_PLACEMENT_"): the parameter is absent OR still has the
-- macro's literal value. pages.rules_check just accepts the new matchers (the
-- shape is the same: name + exactly one of equals | contains | present |
-- not_equals | absent_or_equals).
-- ============================================================================
